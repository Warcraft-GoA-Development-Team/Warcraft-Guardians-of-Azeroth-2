...
<project_key> = {
	...
	# trigger list of names for this project
	# define a sensible default with no triggers as last entry for fallback names.
	#
	# Supported scopes:
	...
	name = {
		...
		desc = loc_key			        # loc key for a specific names
	}
	...
	# broad category of rulers who are allowed to invest in contributions for this project. Default is vassals and owner
	#
	# Possible values:
	...
	#	owner: the owner of the project themself
	...
	project_contributions = {
		...
		<key> = {
			...
			### Brief: allowed_contributor_filter ( bitmask, optional )
			# broad category of rulers who are allowed to invest in this specific contributions for this project.
			# if left empty, this contribution will follow the rules from the parent Great Project
			#
			allowed_contributor_filter = { }
	...
	# Which Title tier should be highlighted on the map in planning mode?
	# Default is barony
	target_title_tier = barony
