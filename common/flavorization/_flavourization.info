...
flavourization_type = {
	...
	### brief: subject_contract_obligation_flags ( array of flags )
	# Does the context character have one of a list of specific subject contract flags?
	# Looks at flags set on vassal and tributary contracts, as well as tax slots.
	#
	# Only applies if the type is character or title.
	#
	# Contract data is contained in:
