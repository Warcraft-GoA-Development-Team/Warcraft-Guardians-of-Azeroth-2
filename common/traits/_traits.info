...
potential = { # Triggers that must be met for this trait to be given to a character. This is not re-checked after it's been applied. This will not run in ruler designer. Any non-potential traits will be purged on game start.
	<triggers>
}
