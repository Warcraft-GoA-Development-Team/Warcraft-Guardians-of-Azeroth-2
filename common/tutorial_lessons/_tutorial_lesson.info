...
lesson_name = {	# arbitrary name
	...
	lesson_step_1 = { # arbitrary name
		...
		# Thesse effect will fire when the the tutorial transitions to this step
		interface_effect = { ... } # Any lesson can run interface only effects
		effect = { ... }		# Only the game state tutorial can run logical effects as well
		
		# Highlight specific widget specific index
		highlight_widget_with_index = {
			name = index
		}

		# Highlight specific child widget with name
		highlight_child_widget_of = {
